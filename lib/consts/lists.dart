...
const featuredList1 = [cat1,cat2,cat3];
const featuredList2 = [cat4,cat5,cat6];

const featuredTitles1 = [beach, mountain, camping];
const featuredTitles2 = [adventure, history, relax];

const homeButtonTitle = ["Flights", "Hotel", "Guide"];
const homeButtonIcon = [icDeparture, icBed, icCustomerJourney];
